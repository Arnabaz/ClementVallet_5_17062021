...
// Appel de la fonction de vérification de l'iD produit
verifyingIdProduct(idProduct)
    .then((response) => {
        // Si l'ID du produit n'est pas présent dans la BDD :
        if (!response) {
            console.log("ID du produit non valable");
            // Revenir à la page d'accueil
            document.location.href = "./index.html";
            // Si l'ID du produit est vérifié et OK :
        } else {
