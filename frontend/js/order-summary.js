...
let orderNumberElement = document.querySelector(".order-section__order-number"); // Variable pour viser l'élément du numéro de commande
let orderPriceElement = document.querySelector(".order-section__order-price"); // Variable pour viser l'élément du prix de la commande
...
function orderSummary () {
    ...
    orderNumberElement.textContent = `Numéro de commande : ${orderData.orderId}`;
    orderPriceElement.textContent = `Montant total de votre commande : ${totalPriceOrder}€`;
}
orderSummary();
